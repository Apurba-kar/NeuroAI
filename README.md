...
# MongoDB
DATABASE=mongodb+srv://<USERNAME>:<PASSWORD>@cluster.mongodb.net/neuroai
...
EMAIL_FROM=NeuroAI <noreply@neuroai.com>
...
└── frontend/
    ...
    └── src/
        ...
        │   ├── Toast.tsx
        │   ├── LoadingSpinner.tsx
        │   ├── VolumeViewer.tsx   # Cornerstone/VTK DICOM viewer
        │   └── ProtectedRoute.tsx
        ├── pages/
        │   ├── HomePage.tsx
        │   ├── LoginPage.tsx
...
NeuroAI implements multiple layers of security:

- **[Helmet.js](https://helmetjs.github.io/)** — Secure HTTP headers
- **[express-rate-limit](https://www.npmjs.com/package/express-rate-limit)** — API rate limiting to prevent brute force
- **[express-mongo-sanitize](https://www.npmjs.com/package/express-mongo-sanitize)** — NoSQL injection protection
- **[xss-clean](https://www.npmjs.com/package/xss-clean)** — XSS attack prevention
